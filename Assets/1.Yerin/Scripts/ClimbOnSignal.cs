...
public class ClimbOnSignal : MonoBehaviour
{
    public enum ClimbMode { AddBy, MoveTo }

    [Header("Motion")]
    public ClimbMode mode = ClimbMode.AddBy;  // AddBy: 현재에서 +amount, MoveTo: targetY로 이동
